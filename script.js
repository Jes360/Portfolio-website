...
const terminalCommands = {
    ...
    projects: "Highlighted Projects:<br>1. <strong>active-directory-lab</strong>: Active Directory enterprise deployment and log ingestion lab.<br>2. <strong>splunk-homelab</strong>: Splunk SIEM configuration and Docker log forwarding engine.<br>3. <strong>volatility</strong>: Memory forensics & process injection identification.<br>4. <strong>wifi</strong>: WiFi pcap decryption & network forensics.<br>5. <strong>appattack</strong>: Automated security testing toolkit in Python/Bash.<br>6. <strong>pipeline</strong>: Jenkins declarative CI/CD security gate pipeline.<br>7. <strong>sdn</strong>: Mininet network topology creation & DoS simulation.<br><em>Type 'open [project_name]' (e.g., 'open volatility') to launch the visual writeup modal.</em>",
